...
contract("Dex:MarketOrders", accounts => {
    ...
    it("Should throw an error when creating a sell market order without adequate token balance", async () => {
        ...
        await truffleAssert.reverts(
            dex.createMarketOrder(Dex.Side.SELL, web3.utils.fromUtf8("LINK"), 10)
        )
    })
    ...
    it("Market orders can be submitted even if the order book is empty", async () => {
        ...
        let orderbook = await dex.getOrderBook(web3.utils.fromUtf8("LINK"), Dex.Side.BUY); //Get buy side orderbook
        assert(orderbook.length == 0, "Buy side Orderbook length is not 0");

        await truffleAssert.passes(
            dex.createMarketOrder(Dex.Side.BUY, web3.utils.fromUtf8("LINK"), 10)
        )
    })
    ...
    it("Market orders should not fill more limit orders than the market order amount", async () => {
        ...
        let orderbook = await dex.getOrderBook(web3.utils.fromUtf8("LINK"), Dex.Side.SELL); //Get sell side orderbook
        assert(orderbook.length == 0, "Sell side Orderbook should be empty at start of test");

        await dex.addToken(web3.utils.fromUtf8("LINK"), link.address)


        //Send LINK tokens to accounts 1, 2, 3 from account 0 (external from the dex)
        ...
        await dex.createLimitOrder(Dex.Side.SELL, web3.utils.fromUtf8("LINK"), 5, 300, {from: accounts[1]})
        await dex.createLimitOrder(Dex.Side.SELL, web3.utils.fromUtf8("LINK"), 5, 400, {from: accounts[2]})
        await dex.createLimitOrder(Dex.Side.SELL, web3.utils.fromUtf8("LINK"), 5, 500, {from: accounts[3]})

        //Create market order that should fill 2/3 orders in the book
        await dex.createMarketOrder(Dex.Side.BUY, web3.utils.fromUtf8("LINK"), 10);

        orderbook = await dex.getOrderBook(web3.utils.fromUtf8("LINK"), Dex.Side.SELL); //Get sell side orderbook
    ...
    it("Market orders should be filled until the order book is empty", async () => {
        ...
        await dex.createLimitOrder(Dex.Side.SELL, web3.utils.fromUtf8("LINK"), 5, 400, {from: accounts[1]})
        await dex.createLimitOrder(Dex.Side.SELL, web3.utils.fromUtf8("LINK"), 5, 500, {from: accounts[2]})
        ...
        await dex.createMarketOrder(Dex.Side.BUY, web3.utils.fromUtf8("LINK"), 50);
    ...
    it("The eth balance of the buyer should decrease with the filled amount", async () => {
        ...
        await dex.createLimitOrder(Dex.Side.SELL, web3.utils.fromUtf8("LINK"), 1, 300, {from: accounts[1]})
    ...
    it("The token balances of the limit order sellers should decrease with the filled amounts.", async () => {
        ...
        await dex.createLimitOrder(Dex.Side.SELL, web3.utils.fromUtf8("LINK"), 1, 300, {from: accounts[1]})
        await dex.createLimitOrder(Dex.Side.SELL, web3.utils.fromUtf8("LINK"), 1, 400, {from: accounts[2]})
        ...
        await dex.createMarketOrder(Dex.Side.BUY, web3.utils.fromUtf8("LINK"), 2);
    ...
    it("Should throw an error when creating a buy market order without adequate ETH balance", async () => {
        ...
        await truffleAssert.reverts(
            dex.createMarketOrder(Dex.Side.BUY, web3.utils.fromUtf8("LINK"), 5, {from: accounts[4]})
        )
    })
